// ============================================================================
// INSTALL SKILL MODAL
// Modal for selecting scope and project when installing built-in skills
// ============================================================================
...
interface InstallSkillModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onInstall: (skill: BuiltInSkill, scope: 'user' | 'project', projectPath: string | null) => void;
}
...
export function InstallSkillModal({
  ...
  // Format skill name with / prefix if not already present
  const displayName = skill.name.startsWith('/') ? skill.name : `/${skill.name}`;
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {skill.allowedTools.length > 4 && (
                        <span className="text-xs text-surface-600">
                          +{skill.allowedTools.length - 4} more
                        </span>
                      )}
                    </div>
                  </div>
